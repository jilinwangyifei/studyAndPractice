...
public abstract class AbstractQueuedSynchronizer
    ...
    public final boolean owns(ConditionObject condition) {
        return condition.isOwnedBy(SourceCodeAnnotation.AbstractQueuedSynchronizer.this);
    }
    ...
    public class ConditionObject implements Condition, java.io.Serializable {
         ...
         * @return {@code true} if owned
         */
        final boolean isOwnedBy(SourceCodeAnnotation.AbstractQueuedSynchronizer sync) {
            return sync == SourceCodeAnnotation.AbstractQueuedSynchronizer.this;
        }
