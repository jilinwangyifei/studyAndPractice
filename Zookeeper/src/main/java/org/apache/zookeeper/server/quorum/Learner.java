...
public class Learner {       
    ...
    */
    ...
    /**
     * 此处和learnHandler交互过程
     * 1. follower向leader发送 Leader.FOLLOWERINFO 信息
     * 2. leader收集(getEpochToPropose方法)所有follower传过来的zxid 遵循过半原则
     * 3. leader向follower发送Leader.LEADERINFO 信息
     * 4. follwer 向leader发送Leader.ACKEPOCH 信息
     * 5. leader再次收集follower发送过来的ACKEPOCH信息 遵循过半原则
     */
    //向leader发送follower的zxid等信息  type类型 pktType(Leader.FOLLOWERINFO)
    protected long registerWithLeader(int pktType) throws IOException{
        ...
        qp.setType(pktType);// Leader.FOLLOWERINFO
